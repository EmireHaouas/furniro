...
import bannercontact from "../../assets/imgs/bannercontact.webp";
const Contact = () => {
    return (
        <div>
            ...
            <div className="map_Contact">
                <div className="infos">
                    <div className="sub_Info">
                        ...
                        <p className="p2_Infos">
                            236 5th SE Avenue, New<br></br>
                            York NY10000, United<br></br> States
                        </p>
                    </div>
                    ...
                    <div className="sub_Info">
                        ...
                        <p className="p2_Infos">
                            Monday-Friday: 9:00<br></br>- 22:00<br></br>
