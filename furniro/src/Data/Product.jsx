import syltherineImage from "../assets/imgs/syltherineB.webp";
import leviosaImage from "../assets/imgs/leviosaB.webp";
import lolitoImage from "../assets/imgs/lolitoB.webp";
import respiraImage from "../assets/imgs/respiraB.webp";
import zephyrImage from "../assets/imgs/zephyrB.webp";
import astraImage from "../assets/imgs/astraB.webp";
import pinkgyImage from "../assets/imgs/pinkgyB.webp";
import pottyImage from "../assets/imgs/pottyB.webp";
import velloriaImage from "../assets/imgs/velloriaB.webp";
import lunaraImage from "../assets/imgs/lunaraB.webp";
import tesseraImage from "../assets/imgs/tesseraB.webp";
import nyvoraImage from "../assets/imgs/nyvoraB.webp";
import aqualisImage from "../assets/imgs/aqualisB.webp";
import orlinaImage from "../assets/imgs/orlinaB.webp";
import mirellaImage from "../assets/imgs/mirellaB.webp";
import eliraImage from "../assets/imgs/eliraB.webp";
...
const products = [
  ...
  },
  {
    ...
    image: leviosaImage,
    description:
        "The Leviosa chair combines luxurious suede with a sleek, modern design to create the perfect blend of comfort and style. Its soft, high-quality suede upholstery offers a rich tactile experience, while its elegant silhouette makes it a standout piece in any room. Ideal for living spaces, dining areas, or offices, the Leviosa chair brings both sophistication and comfort to your decor. Designed with both aesthetics and durability in mind, it’s a timeless piece that elevates any setting.",
    price: 150,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    image: lunaraImage,
    description:
        "The Lunara dining table is a perfect blend of elegance and contemporary style, crafted from high-quality wood with a sleek, on-trend design. Its clean lines and sophisticated finish make it an ideal centerpiece for modern dining rooms, while the sturdy construction ensures lasting durability. The Lunara table’s understated beauty effortlessly complements a variety of interior styles, adding both warmth and sophistication to your space. Whether hosting a dinner party or enjoying a casual meal, this elegant dining table offers both functionality and timeless appeal, elevating any dining experience.",
    price: 399,
  },
  {
    id: 11,
