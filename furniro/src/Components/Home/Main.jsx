...
import background_banner from "../../assets//imgs/background_banner.webp";
import bedroom from "../../assets/imgs/bedroom.webp";
import dining from "../../assets/imgs/dining.webp";
import living from "../../assets/imgs/living.webp";
import syltherine from "../../assets/imgs/syltherine.webp";
import respira from "../../assets/imgs/respira.webp";
import potty from "../../assets/imgs/potty.webp";
import pinkgy from "../../assets/imgs/pinkgy.webp";
import lolito from "../../assets/imgs/lolito.png";
import leviosa from "../../assets/imgs/leviosa.webp";
import astra from "../../assets/imgs/astra.webp";
import share_Img from "../../assets/imgs/share_Img.webp";
import Zephyr from "../../assets/imgs/Zephyr.webp";
import velloria from "../../assets/imgs/velloria.webp";
import lunara from "../../assets/imgs/lunara.webp";
import tessera from "../../assets/imgs/tessera.webp";
import nyvora from "../../assets/imgs/nyvora.webp";
import aqualis from "../../assets/imgs/aqualis.webp";
import orlina from "../../assets/imgs/orlina.webp";
import mirella from "../../assets/imgs/mirella.webp";
import elira from "../../assets/imgs/elira.webp";
            ...
            <section className="our_Products">
                ...
                <div className="products">
                    <div className="row1_Products">
                        <div
                            className="slytherine_Product"
                            onClick={() => handleProductClick(products[0].id)}
                        >
                            <img
                                className="syltherine_Img"
                                alt="Syltherine"
                                src={syltherine}
                            />
                    ...
                    <div className="row2_Products">
                        ...
                        <div
                            className="pinkgy_Product"
                            onClick={() => handleProductClick(products[6].id)}
                        >
                        ...
                        <div
                            className="potty_Product"
                            onClick={() => handleProductClick(products[7].id)}
                        >
                ...
                {showMore && (
                    <div className="products2">
                        <div className="row1_Products">
                            <div
                                className="velloria_Product"
                                onClick={() => handleProductClick(products[8].id)}
                            >
                                <img
                                    className="syltherine_Img"
                                    alt="Syltherine"
                            ...
                            <div
                                className="lunara_Product"
                                onClick={() => handleProductClick(products[9].id)}
                            >
                            ...
                            <div
                                className="tessera_Product"
                                onClick={() => handleProductClick(products[10].id)}
                            >
                            ...
                            <div
                                className="nyvora_Product"
                                onClick={() => handleProductClick(products[11].id)}
                            >
                        ...
                        <div className="row2_Products">
                            <div
                                className="aqualis_Product"
                                onClick={() => handleProductClick(products[12].id)}
                            >
                                <img className="zephyr_Img" alt="" src={aqualis} />
                                <p className="name_Product">{products[12].name}</p>
                                <p className="details_Product">
                            ...
                            <div
                                className="orlina_Product"
                                onClick={() => handleProductClick(products[13].id)}
                            >
                            ...
                            <div
                                className="mirella_Product"
                                onClick={() => handleProductClick(products[14].id)}
                            >
                            ...
                            <div
                                className="elira_Product"
                                onClick={() => handleProductClick(products[15].id)}
                            >
